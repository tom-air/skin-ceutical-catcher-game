...
import BrandLogo from 'https://skinc-cny.oss-cn-shenzhen.aliyuncs.com/assets/Logo_white.png';
import CatchCircle from 'https://skinc-cny.oss-cn-shenzhen.aliyuncs.com/assets/ar_teach_catch_circle.png';
import CatchCTAArrow from 'https://skinc-cny.oss-cn-shenzhen.aliyuncs.com/assets/selfie_result_cta_arrow.png';
import CatchButton from 'https://skinc-cny.oss-cn-shenzhen.aliyuncs.com/assets/selfie_result_catch_btn.png';
import ActiveCatchCircle from 'https://skinc-cny.oss-cn-shenzhen.aliyuncs.com/assets/ar_active_catch_circle.png';
import CatchCircleBg from 'https://skinc-cny.oss-cn-shenzhen.aliyuncs.com/assets/ar_catch_circle_bg.png';
import SelfieResultWinkles from 'https://skinc-cny.oss-cn-shenzhen.aliyuncs.com/assets/selfie_result_wrinkle.png';
import ArBenifitArrow from 'https://skinc-cny.oss-cn-shenzhen.aliyuncs.com/assets/ar_benifit.png';
import PlayInfoArea from 'https://skinc-cny.oss-cn-shenzhen.aliyuncs.com/assets/player_info_area.png';
import TargetArrow from 'https://skinc-cny.oss-cn-shenzhen.aliyuncs.com/assets/target_arrow.svg';
import ArMeasureElement from 'https://skinc-cny.oss-cn-shenzhen.aliyuncs.com/assets/ar_measure_element.png';
...
const GamePage = () => {
  let camera, scene, renderer, controls, video, track, raycaster, intersects;
  ...
  const detectTargetInAim = (element) => {
    raycaster = new THREE.Raycaster(camera.position, camera.getWorldDirection());
    intersects = raycaster.intersectObjects(element);
  ...
  const unmount = track && track.stop();
